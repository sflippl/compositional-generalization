...
fig
ggsave('../figures/neurips/neurips-addition-dispersed.pdf', width = width, height = 0.45*width, units = 'cm')
```
...
fig <- fig + plot_annotation(tag_levels = 'a')
fig
ggsave('../figures/neurips/neurips-addition-rich.pdf', width = width, height = 0.65*width, units = 'cm')
```
...
fig
ggsave('../figures/neurips/neurips-addition-mnist.pdf', width = width*2/3, height = 0.45*width, units = 'cm')
```
...
ggsave('../figures/neurips/neurips-addition-cifar.pdf', width = width, height = 0.65*width, units = 'cm')
```
